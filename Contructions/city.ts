  ...
  public services(creator: Creator): void {
    ...
    while (true) {
      if (option === '1') {
        ...
        // Após a venda, você pode retornar ao menu principal ou continuar o loop, dependendo da lógica do seu jogo
        ...
        // Encerrando o loop depois da venda, mas você pode continuar caso deseje
        break;
      } else if (option === '3') {
        ...
        // Após melhorar o equipamento, você pode retornar ao menu principal ou continuar o loop, dependendo da lógica do seu jogo
      } else if (option === '4') {
        console.log('Até mais! Volte sempre à loja do ferreiro.');
        break; // Saindo do loop quando o usuário escolhe "Sair"
      } else {
        console.log('Opção inválida. Por favor, escolha uma opção válida.');
        option = write('Digite a opção: '); // Solicitando novamente a opção
      }
    }
  }
}
